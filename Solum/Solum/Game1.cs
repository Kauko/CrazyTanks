...
namespace Solum
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            TextureRefs.tank_green = this.Content.Load<Texture2D>("Images/TankkiVihre‰2");
            ...
            TextureRefs.turret_green = this.Content.Load<Texture2D>("Images/TurrettiVihre‰2");
            ...
            TextureRefs.TurretShield_green = this.Content.Load<Texture2D>("Images/TurrettiVihre‰1Kilpi");
